...
InteropWrapNode_Handle androidx_compose_ui_arkui_utils_create_interop_wrap_node() {
    const auto wrapNode = new OH::InteropWrapView();
    LOGI("androidx_compose_ui_arkui_utils_create_interop_wrap_node: "
         "wrapNode=%{public}p",
         wrapNode);
...
BaseRenderNode_Handle androidx_compose_ui_arkui_utils_get_interop_render_node(InteropWrapNode_Handle wrappingView) {
    ...
    auto baseRenderNode = nativeInteropWrapView->getBaseRenderNodePtr();
...
void androidx_compose_ui_arkui_utils_set_user_interaction_enable(InteropWrapNode_Handle wrappingView, bool interactionEnable) {
    //auto nativeInteropWrapView = reinterpret_cast<OH::InteropWrapView *>(wrappingView);
    //nativeInteropWrapView->setUserInteraction(interactionEnable);
}
...
napi_value androidx_compose_ui_arkui_utils_create_mixed_view(const char* name, napi_value parameter) {
    ...
    return instance -> CreateMixedNode(name, parameter);
}
...
//        bool drawInSkia
//) {
//    auto impl = new InteractionUIViewImpl(
//            context,
//            pointInsideCallback,
//            touchesEventCallback,
//            updateTouchesCallback,
//            checkBoundsCallback,
//            keyboardEventCallback,
//            becomeFirstResponder,
//            drawInSkia
//    );
//    return (InteractionUIViewHandle)impl;
//}
//
//void destroyInteractionUIView(InteractionUIViewHandle handle) {
//    if (handle) {
//        delete static_cast<InteractionUIViewImpl*>(handle);
//    }
//}
//
//void touchesBegan(InteractionUIViewHandle handle, void* touches, void* event) {
//    if (handle) {
//        auto impl = static_cast<InteractionUIViewImpl*>(handle);
//        impl->handleTouchesBegan(touches, event);
//    }
//}
//
...
//    if (handle) {
//        auto impl = static_cast<InteractionUIViewImpl*>(handle);
//        impl->handleTouchesEnded(touches, event);
//    }
//}
